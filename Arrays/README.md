...
Once you push Two Sum, just add row number 4 to that table. Every new problem = one new row. That is it — nothing complicated.

Use this commit message when you update the README:
```
Update Arrays README — add Two Sum to problem table
